...
export const Vehicles = ({ uid, properties, _id }) => {
        ...
        <div className="col-md-3">
            <div className="card text-wrap mb-3">
                ...
                <div className="card-body">
                    ...
                    <p className="card-text m-1"><strong>Model:</strong> {properties.model}</p>
                    <p className="card-text m-1"><strong>Vehicle Class:</strong> {properties.vehicle_class}</p>
                    <div className="d-flex justify-content-between mt-3">
                        <Link to={`/vehicles/${uid}`} className="btn btn-outline-info">Go somewhere</Link>
